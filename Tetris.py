...
pygame.display.set_caption("TETRIS - DK RYN")
...
katyusha = pygame.mixer.Sound('Music/kalinka.ogg')
korobushka = pygame.mixer.Sound('Music/kalinka.ogg')
smuglianka = pygame.mixer.Sound('Music/kalinka.ogg')
